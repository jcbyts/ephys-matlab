...
%%
[eyedata, eyetime] = io.getEyeData(thisSession, PDS);
%%
...
%% make stimulus movie
frameIndex = [1 2e3];
Ibig = pds.replayTrial(PDS{2}, 31, 'writeToFile', true); %'frameIndex', frameIndex);
% Ismall = pds.replayTrial(PDS{3}, 1, 'frameIndex', frameIndex);
%%
