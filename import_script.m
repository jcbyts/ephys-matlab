...
preprocess.runKiloSort(thisSession)
%% sort with threshold
...
sp = io.getSpikes(thisSession, 'threshold');
...
sta = spatialMap.spikeTriggeredAverage(stim, Xd, spikeTimes, 10e8);
...
plot(sta.RFtime)
subplot(1,3,3)
imagesc(stim.xax, stim.yax,sta.RF);
axis xy
